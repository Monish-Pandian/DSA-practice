/**
 * Problem: Max Active Sections After Trade II (#3904)
 * Difficulty: Hard
 * Pattern: Segment Tree, Binary Search, Run Length Encoding (RLE)
 * Time Complexity: O(n + q log n)
 * Space Complexity: O(n)
 * LeetCode: https://leetcode.com/problems/maximize-active-section-after-trade-ii/
 */
